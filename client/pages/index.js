...
export default function Index() {
	...
	// Adjust this function to safely handle window resizing
	...
	// Use useEffect to attach the event listener in a browser environment
	useEffect(() => {
	  handleWindowSize(); // Set initial width
